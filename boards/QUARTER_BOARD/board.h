...
#define BOARD_NAME                  "Compotes Quarter Board"
...
#define IR_SENSORS_GPIO GPIOA
#define USART_GPIO GPIOA
#define MIDDLE_CONFIRM_GPIO GPIOA
#define RED_LED_GPIO GPIOB

/*
 * IO pins assignments.
 */
#define MIDDLE_CONFIRM              0U
#define GPIOA_PIN1                  1U
#define USART_TX                    2U
#define USART_RX                    3U
#define GPIOA_PIN4                  4U
#define ANALOG_IN                   5U
#define IR_SENSOR_2                 6U
#define GREEN_LED                   7U
#define GPIOA_PIN8                  8U
#define IR_SENSOR_1                 9U
 ...
 * GPIOA setup:
 *
 * PA0  - MIDDLE_CONFIRM            (input pullup).
 * PA1  - PIN1                      (input pullup).
 * PA2  - USART_TX                  (alternate 1).
 * PA3  - USART_RX                  (alternate 1).
 * PA4  - PIN4                      (input pullup).
 * PA5  - ANALOG_IN                 (analog).
 * PA6  - SENSOR_2                  (alternate 1).
 * PA7  - GREEN_LED                 (output pushpull high).
 * PA8  - PIN8                      (input pullup).
 * PA9  - SENSOR_1                  (alternate 2).
 ...
 */
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(MIDDLE_CONFIRM) |       \
                                     PIN_MODE_INPUT(GPIOA_PIN1) |           \
                                     PIN_MODE_ALTERNATE(USART_TX) |         \
                                     PIN_MODE_ALTERNATE(USART_RX) |         \
                                     PIN_MODE_INPUT(GPIOA_PIN4) |           \
                                     PIN_MODE_ANALOG(ANALOG_IN) |           \
                                     PIN_MODE_ALTERNATE(IR_SENSOR_2) |      \
                                     PIN_MODE_OUTPUT(GREEN_LED) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN8) |           \
                                     PIN_MODE_ALTERNATE(IR_SENSOR_1) |      \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(MIDDLE_CONFIRM) |   \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN1) |       \
                                     PIN_OTYPE_PUSHPULL(USART_TX) |         \
                                     PIN_OTYPE_PUSHPULL(USART_RX) |         \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN4) |       \
                                     PIN_OTYPE_PUSHPULL(ANALOG_IN) |        \
                                     PIN_OTYPE_PUSHPULL(IR_SENSOR_2) |      \
                                     PIN_OTYPE_PUSHPULL(GREEN_LED) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN8) |       \
                                     PIN_OTYPE_PUSHPULL(IR_SENSOR_1) |      \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_40M(MIDDLE_CONFIRM) |       \
                                     PIN_OSPEED_40M(GPIOA_PIN1) |           \
                                     PIN_OSPEED_40M(USART_TX) |             \
                                     PIN_OSPEED_40M(USART_RX) |             \
                                     PIN_OSPEED_40M(GPIOA_PIN4) |           \
                                     PIN_OSPEED_40M(ANALOG_IN) |            \
                                     PIN_OSPEED_40M(IR_SENSOR_2) |          \
                                     PIN_OSPEED_40M(GREEN_LED) |            \
                                     PIN_OSPEED_40M(GPIOA_PIN8) |           \
                                     PIN_OSPEED_40M(IR_SENSOR_1) |          \
                                     PIN_OSPEED_40M(GPIOA_PIN10) |          \
                                     PIN_OSPEED_40M(GPIOA_PIN11) |          \
                                     PIN_OSPEED_40M(GPIOA_PIN12) |          \
                                     PIN_OSPEED_40M(SWDIO) |                \
                                     PIN_OSPEED_40M(SWCLK) |                \
                                     PIN_OSPEED_40M(GPIOA_PIN15))
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(MIDDLE_CONFIRM) |     \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN1) |         \
                                     PIN_PUPDR_FLOATING(USART_TX) |         \
                                     PIN_PUPDR_FLOATING(USART_RX) |         \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN4) |         \
                                     PIN_PUPDR_FLOATING(ANALOG_IN) |        \
                                     PIN_PUPDR_FLOATING(IR_SENSOR_2) |      \
                                     PIN_PUPDR_FLOATING(GREEN_LED) |        \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN8) |         \
                                     PIN_PUPDR_FLOATING(IR_SENSOR_1) |      \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN10) |        \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN11) |        \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN12) |        \
                                     PIN_PUPDR_PULLUP(SWDIO) |              \
                                     PIN_PUPDR_PULLDOWN(SWCLK) |            \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN15))
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(MIDDLE_CONFIRM) |         \
                                     PIN_ODR_HIGH(GPIOA_PIN1) |             \
                                     PIN_ODR_HIGH(USART_TX) |               \
                                     PIN_ODR_HIGH(USART_RX) |               \
                                     PIN_ODR_HIGH(GPIOA_PIN4) |             \
                                     PIN_ODR_HIGH(ANALOG_IN) |              \
                                     PIN_ODR_HIGH(IR_SENSOR_2) |            \
                                     PIN_ODR_HIGH(GREEN_LED) |              \
                                     PIN_ODR_HIGH(GPIOA_PIN8) |             \
                                     PIN_ODR_HIGH(IR_SENSOR_1) |            \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(MIDDLE_CONFIRM, 0) |       \
                                     PIN_AFIO_AF(GPIOA_PIN1, 0) |           \
                                     PIN_AFIO_AF(USART_TX, 1) |             \
                                     PIN_AFIO_AF(USART_RX, 1) |             \
                                     PIN_AFIO_AF(GPIOA_PIN4, 0) |           \
                                     PIN_AFIO_AF(ANALOG_IN, 0) |            \
                                     PIN_AFIO_AF(IR_SENSOR_2, 1) |          \
                                     PIN_AFIO_AF(GREEN_LED, 0))
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_PIN8, 0) |           \
                                     PIN_AFIO_AF(IR_SENSOR_1, 2) |          \
...
extern uint8_t i_am_middle_one;
